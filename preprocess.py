...
def main():
    ...
    arg('--image-path', type=str, default="e:/diploma/clusterization/test_data/ISIC2018_Task1-2_Training_Input/", help='training image path')
    arg('--mask-path', type=str, default='e:/diploma/clusterization/test_data/ISIC2018_Task2_Training_GroundTruth_v3/', help='ground truth mask path')
